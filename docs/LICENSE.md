...
この利用規約（以下、「本規約」といいます。）は、とんとんぱぁ/はるかんどらぁのbot首脳陣（以下、「当グループ」といいます。）が Discord 社の Discord 上で提供するサービスである「ダイス・ダイス！」（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。） には、本規約に従って、本サービスをご利用いただきます。

## 第 0 条（読むのめんどい人向けまとめ）

規約を読むのがめんどくさい人向けにまとめさせていただきます。

- この規約は、ダイス・ダイス！ を使う人に適用されるよ。
...
本サービスにおいては、本サービスをユーザーの Discord サーバーに参加させた場合、もしくはマイアプリ登録した場合、またはその両方の場合に利用登録がされたものとします。
...
本規約は2025/12/23 00:00(GMT+09:00)をもって制定するものとする。
